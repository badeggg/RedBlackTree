...
tap.test('indexInSortedArray basic', async tap => {
    ...
    tap.equal(tree.indexInSortedArray(0), 0);
    tap.equal(tree.indexInSortedArray(6), 6);
    tap.equal(tree.indexInSortedArray(88), 88);
    tap.equal(tree.indexInSortedArray(100), 100);
    tap.equal(tree.indexInSortedArray(999), -1);
});
